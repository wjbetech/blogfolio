          ...
          <section className="my-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-bg-200 rounded-lg p-6">
                ...
                <p className="text-paragraph">
                  After 10 years of living in Korea and experience with a vast array of Korean content and media, I can
                  provide effective localizations for the web, games, film and more.
                </p>
              </div>
              <div className="bg-bg-200 rounded-lg p-6">
            ...
            <ul className="space-y-4">
              ...
              <li className="">
                ...
                <p>
                  ...
                  brochures and promotional materials for the university.
                </p>
              </li>
              <li className="">
                <h1 className="font-bold">
              ...
              <li className="">
                ...
                <p>
                  ...
                  Competition winner&apos;s poem from Korean in to English.
                </p>
              </li>
              <li className="">
                <h1 className="font-bold">
              ...
              <li className="">
                ...
                <p>
                  ...
                  ministry&apos;s efforts to promote peace and reunification on the Korean peninsula.
                </p>
              </li>
              <li className="">
                <h1 className="font-bold">
