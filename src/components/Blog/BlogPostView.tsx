...
export default function BlogPostView({ post, allPosts }: Props) {
  ...
  return (
    <article className="mx-auto w-full max-w-7xl">
      ...
      <header className="mx-auto max-w-7xl space-y-5 mt-10 mb-14">
        <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold leading-[0.92] tracking-tight text-balance text-headline">
          {post.title}
        </h1>

        <div className="flex flex-wrap items-center gap-x-4 gap-y-2 border-y border-accent-100/15 py-3 text-sm text-paragraph/60">
      ...
      <section className="mx-auto max-w-[48rem] mb-10 overflow-hidden rounded-xl">
