...
function StudioHero() {
  return <section className="overflow-hidden border border-palette-border/65 bg-bg-200/35">
    <div className="grid md:grid-cols-[minmax(0,1fr)_minmax(0,0.8fr)]">
      ...
      <div className="relative min-h-72 border-t border-palette-border/60 bg-bg-300 md:min-h-[28rem] md:border-l md:border-t-0"><div className="flex min-h-[18rem] items-center justify-center p-4 sm:p-5 md:min-h-[28rem]"><Portrait className="aspect-[506/478] w-full max-w-[430px]" sizes="430px" /></div><div className="absolute bottom-6 left-6 bg-bg-100/95 px-4 py-3 shadow-lg sm:bottom-7 sm:left-7"><span className="block font-mono text-[11px] uppercase tracking-[0.15em] text-accent-200">Current Location</span><span className="mt-1 block font-semibold text-headline">Seoul, South Korea</span></div></div>
    </div>
  </section>;
}
