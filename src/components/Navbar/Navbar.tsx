            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`flex items-baseline gap-2 relative pb-1 text-sm lg:text-lg transition-colors ${
                  pathname === link.href
                    ? "font-semibold text-accent-200 after:absolute after:bottom-px after:left-0 after:right-0 after:h-3 after:bg-accent-100/50 after:origin-left after:transform after:scale-x-100 after:transition-transform after:duration-200 after:-z-10"
                    : "text-paragraph after:absolute after:bottom-px after:left-0 after:right-0 after:h-3 after:bg-accent-200/50 after:origin-left after:transform after:scale-x-0 after:transition-transform after:duration-200 hover:after:scale-x-100 after:-z-10"
                }`}>
