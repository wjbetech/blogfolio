...
export const PLAUSIBLE_SCRIPT_SRC =
  process.env.NEXT_PUBLIC_PLAUSIBLE_SCRIPT_SRC ?? "https://plausible.io/js/script.manual.js";
export const ANALYTICS_ENABLED = PLAUSIBLE_DOMAIN.length > 0;

export type AnalyticsValue = string | number | boolean;
export type AnalyticsProps = Record<string, AnalyticsValue>;
export type AnalyticsEventName = "Contact Click" | "Project CTA Click" | "Project Card Click";
